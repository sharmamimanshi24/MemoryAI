...
export default function Landing() {
  ...
  return (
    <div style={{ 
      ...
      // Using Stritch/Inter for a premium look
      fontFamily: "'Stritch', 'Inter', sans-serif", 
      width: "100%",
      position: "fixed",
      display: "block", 
      overflowY: "auto", // Enables manual mouse scroll
      overflowX: "hidden"
    }}
    >
...
<h2 style={{ fontSize: "clamp(1.2rem, 3vw, 2rem)", fontWeight: 500, margin: "10px 0 40px", paddingBottom: "10px" }}>
  <BlurText text="An agent that actually knows you." delay={300} direction="top" style={{ color: currentTheme.textSecondary }} />
          ...
          <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.8 }}
            style={{ fontSize: "1.2rem", color: currentTheme.textTertiary, lineHeight: 1.8, maxWidth: "600px", margin: "30px auto 50px" }}>
